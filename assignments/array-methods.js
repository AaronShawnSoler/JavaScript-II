...
const runnersLargeSizeShirt = runners.filter(element => element.shirt_size === 'L');
...
const ticketPriceTotal = donations.reduce(reducer);
...
// Problem 1: list of names in alphabetical order
const organizeNames = runners.slice();
organizeNames.sort((a, b) => (a.first_name > b.first_name ? 1 : -1));

const firstNameAlphabetical = organizeNames;

console.log(firstNameAlphabetical);

// Problem 2: Group people by their shirt size (XS, S, M, L, XL, 2XL, 3XL) and count how many of each shirt you need.
const shirtXS = runners.filter(element => element.shirt_size === 'XS');
const shirtS = runners.filter(element => element.shirt_size === 'S');
const shirtM = runners.filter(element => element.shirt_size === 'M');
const shirtL = runners.filter(element => element.shirt_size === 'L');
const shirtXL = runners.filter(element => element.shirt_size === 'XL');
const shirt2XL = runners.filter(element => element.shirt_size === '2XL');
const shirt3XL = runners.filter(element => element.shirt_size === '3XL');

const numShirtsXS = shirtXS.length;
const numShirtsS = shirtS.length;
const numShirtsM = shirtM.length;
const numShirtsL = shirtL.length;
const numShirtsXL = shirtXL.length;
const numShirts2XL = shirt2XL.length;
const numShirts3XL = shirt3XL.length;

console.log(`XS: ${numShirtsXS}`);
console.log(`S: ${numShirtsS}`);
console.log(`M: ${numShirtsM}`);
console.log(`L: ${numShirtsL}`);
console.log(`XL: ${numShirtsXL}`);
console.log(`2XL: ${numShirts2XL}`);
console.log(`3XL: ${numShirts3XL}`);

// Problem 3: take 10 percent from each runners donations to charity
const donationsForCharity = [];
runners.forEach(element => donationsForCharity.push(element.donation));

const charityMoney = donationsForCharity.map(element => element * 0.1);
const roundCharity = charityMoney.map(element => parseInt(element.toFixed(4)));

console.log(roundCharity);
